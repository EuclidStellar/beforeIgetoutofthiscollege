    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //         padding: const EdgeInsets.all(8.0),
          //         child: ListTile(
          //           title: Text(tasks[index] , style: const TextStyle(
          //             color: Colors.white,
                    
          //           ),),
          //           trailing: IconButton(
          //             icon: const Icon(Icons.delete , color: Color.fromARGB(255, 207, 88, 80),),
          //             onPressed: () {
          //               deleteTask(index);
          //             },
          //           ),
...
//                     labelText2: 'Only you and your local storage know what you want :)',
//                     secure1: false,
